...
def creer_menu():
    ...
    btn1 = Button(root, text="Un nombre 1er ?", command=lambda: (play_sound("Sounds/huh.mp3"), exo1()))
    btn2 = Button(root, text="Des calculs scientifiques", command=lambda: (play_sound("Sounds/bully.mp3"), exo2_3()))
    btn3 = Button(root, text="Etude sur l'âge de la population", command=lambda: (play_sound("Sounds/ez.mp3"), exo4()))
    btn4 = Button(root, text="Générateur de lancés de dés", command=lambda: (play_sound("Sounds/xp.mp3"), exo5()))
